 ...
 */
export interface RawButtonProps extends Omit<ButtonProps, 'onButtonPress' | 'onButtonPressIn' | 'onButtonPressOut' | 'onButtonLongPress' | 'onButtonHoverIn' | 'onButtonHoverOut' | 'onButtonInteractionFinished' | 'defaultOpacity' | 'defaultScale' | 'defaultUnderlayOpacity' | 'activeOpacity' | 'activeScale' | 'activeUnderlayOpacity' | 'needsOffscreenAlphaCompositing'>, Omit<NativeWrapperProperties<React.ComponentRef<typeof GestureHandlerButton>>, 'hitSlop' | 'enabled' | 'testID'> {
}
/**
