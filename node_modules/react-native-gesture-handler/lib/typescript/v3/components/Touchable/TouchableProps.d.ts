...
import type { ButtonEvent, ButtonProps } from '../../../components/GestureHandlerButton';
...
type InteractionProps = 'onButtonPress' | 'onButtonPressIn' | 'onButtonPressOut' | 'onButtonLongPress' | 'onButtonHoverIn' | 'onButtonHoverOut' | 'onButtonInteractionFinished';
...
export type TouchableProps = Omit<ButtonProps, RippleProps | InteractionProps | 'enabled' | DurationProps> & Omit<BaseButtonProps, keyof RawButtonProps | 'onActiveStateChange' | 'onPress' | 'onLongPress'> & {
    /**
