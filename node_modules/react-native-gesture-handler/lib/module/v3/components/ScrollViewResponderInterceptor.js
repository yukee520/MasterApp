...
import { JSResponderContext, setKeyboardVisibility } from '../scrollViewInterop';
...
function keyboardIsDismissible() {
  ...
  const softKeyboardMayBeOpen = metrics != null || Platform.OS === 'android' && Number(Platform.Version) < 30;
...
export const ScrollViewResponderProvider = ({
  ...
  const handleStartShouldSetResponder = useCallback(event => {
    ...
    const shouldClaim = keyboardIsDismissible() && event.target !== TextInput.State.currentlyFocusedInput();
  ...
  const handleResponderRelease = useCallback(event => {
    ...
    claimedForKeyboardDismissal.current = false;
    const currentlyFocusedInput = TextInput.State.currentlyFocusedInput();
    if (currentlyFocusedInput != null && keyboardIsDismissible() && event.target !== currentlyFocusedInput) {
  ...
  return /*#__PURE__*/_jsx(JSResponderContext, {
    ...
    children: /*#__PURE__*/_jsx(View, {
      ...
      onStartShouldSetResponderCapture: isHandledMode ? resetRNGHResponderEvent : undefined,
      onStartShouldSetResponder: isHandledMode ? handleStartShouldSetResponder : undefined,
      onResponderRelease: isHandledMode ? handleResponderRelease : undefined,
      onResponderTerminate: isHandledMode ? handleResponderTerminate : undefined,
      children: children
    })
  });
};
